...
insert into ride (id, departure_id, arrival_id, comment, traffic_condition, driver_pseudonym) values (0, 0, 1, 'Commentaire', 1, 'lofaloa');
...
insert into ride (id, departure_id, arrival_id, comment, traffic_condition, driver_pseudonym) values (1, 2, 3, 'Commentaire', 1, 'lofaloa');
